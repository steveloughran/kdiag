...
Apache Hadoop 2.8 added tool to aid validating setup: `KDiag`; this is a standalone version for
use on Hadoop 2.6+

KDiag contains a series of probes for the JVM's configuration and the environment,
